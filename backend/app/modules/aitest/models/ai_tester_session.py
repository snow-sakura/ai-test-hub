...
class AITesterSession(BaseModel, TimestampMixin):
    """AI 评测师会话"""
    __tablename__ = "ai_tester_session"
    ...
    messages = relationship(
        "AITesterMessage", back_populates="session",
        cascade="all, delete-orphan", order_by="AITesterMessage.id",
    )
